...
const en = {
    ...
    quotePage: {
      ...
      lead: "Complete the form and our team will confirm availability and pricing. All fields marked with an asterisk are required.",
      contactSection: "Contact details",
      requirementsSection: "Product requirements",
      name: "Full name",
      company: "Company",
      email: "Work email",
      phone: "Phone",
      ...
      productPlaceholder: "Any specific product",
      quantity: "Quantity",
      unit: "Unit",
      unitOptions: { kg: "kg", tonnes: "tonnes", meters: "meters", pieces: "pieces" },
      notes: "Additional specifications",
      notesPlaceholder: "Alloy, temper, dimensions, finish, delivery timeframe, destination…",
